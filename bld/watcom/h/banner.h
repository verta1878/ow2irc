...
#define _BETAVER            1
#define _OWURL              "https://github.com/verta1878/openwatcomirc#readme"

/* openwatcomirc fork identification */
#define _IRC_SUFFIX         "-irc"
#define _IRC_VERSION        "r0.1"
...
#define banner1t(p)         "Open Watcom" _IRC_SUFFIX " " p
