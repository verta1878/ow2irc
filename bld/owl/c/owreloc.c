...
/* openwatcomirc: x86_64 ELF relocation table */
#define X64_RELOC(coff,elf)     elf,
#define X64_RELOCS                          /* coff                         elf */ \
/* OWL_RELOC_ABSOLUTE */        X64_RELOC( COFF_IMAGE_REL_AMD64_ABSOLUTE,   R_X86_64_NONE ) \
/* OWL_RELOC_WORD */            X64_RELOC( COFF_IMAGE_REL_AMD64_ADDR64,     R_X86_64_64 ) \
/* OWL_RELOC_HALF_HI */         X64_RELOC( 0,                               R_X86_64_NONE ) \
/* OWL_RELOC_HALF_HA */         X64_RELOC( 0,                               R_X86_64_NONE ) \
/* OWL_RELOC_PAIR */            X64_RELOC( 0,                               R_X86_64_NONE ) \
/* OWL_RELOC_HALF_LO */         X64_RELOC( COFF_IMAGE_REL_AMD64_REL32,      R_X86_64_PC32 ) \
/* OWL_RELOC_BRANCH_REL */      X64_RELOC( COFF_IMAGE_REL_AMD64_REL32,      R_X86_64_PLT32 ) \
/* OWL_RELOC_BRANCH_ABS */      X64_RELOC( 0,                               R_X86_64_NONE ) \
/* OWL_RELOC_JUMP_REL */        X64_RELOC( COFF_IMAGE_REL_AMD64_REL32,      R_X86_64_PLT32 ) \
/* OWL_RELOC_JUMP_ABS */        X64_RELOC( 0,                               R_X86_64_NONE ) \
/* OWL_RELOC_SECTION_INDEX */   X64_RELOC( COFF_IMAGE_REL_AMD64_SECTION,    R_X86_64_NONE ) \
/* OWL_RELOC_SECTION_OFFSET */  X64_RELOC( COFF_IMAGE_REL_AMD64_SECREL,     R_X86_64_PC32 ) \
/* OWL_RELOC_TOC_OFFSET */      X64_RELOC( 0,                               R_X86_64_GOTPCREL ) \
/* OWL_RELOC_GLUE */            X64_RELOC( 0,                               R_X86_64_NONE )
...
/* openwatcomirc: x86_64 ELF relocs */
static Elf32_Word elfRelocTypesX64[] = {
    X64_RELOCS
};
...
//************************************************************************
    ...
    case OWL_CPU_X86:
        ...
        break;
    case OWL_CPU_X64:
        coff_relocs = coffRelocTypes386; /* placeholder — COFF x64 needs own table */
        break;
    default:
        assert( 0 );
    }
...
//****************************************************************************************************
    ...
    if( cpu == OWL_CPU_ALPHA || cpu == OWL_CPU_X86 || cpu == OWL_CPU_X64 || cpu == OWL_CPU_MIPS ) {
        from += 4;  // Intel, Alpha and MIPS use updated PC
    } // PowerPC uses current PC
    if( cpu != OWL_CPU_X86 && cpu != OWL_CPU_X64 ) {    // no alignment restrictions for Intel
        assert( ( to % 4 ) == 0 );
        assert( ( from % 4 ) == 0 );
    }
    ret = to - from;
    if( cpu == OWL_CPU_PPC || cpu == OWL_CPU_X86 || cpu == OWL_CPU_X64 ) {
        return( ret );
    }
